...
- once a cancellation completes, the stage card falls back to the previous meaningful state or `not-started`, while the cancelled job remains visible in the timeline for auditability
